...
class ProductDescriptionSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        # Include fields relevant to ProductDescription
        fields = ['id', 'description']


class ProductSerializer(serializers.ModelSerializer):
    product_images = ProductImageSerializer(
        many=True, source='productimages_set')  # Use related_name or reverse lookup
    descriptions = ProductDescriptionSerializer(
        many=True, source='productdescription_set')  # Use related_name or reverse lookup
    ...
    def get_discount(self, instance):
        discount = (instance.original_price - instance.price) * \
            100 // instance.original_price
        return discount
